...
export function addHeatmapCalculationOptions(
  ...
  builder.addCustomEditor({
    ...
    name: t('transformers.add-heatmap-calculation-options.name.x-bucket', 'X Bucket'),
    editor: AxisEditor,
    category,
    defaultValue: {
  ...
  builder.addCustomEditor({
    ...
    name: t('transformers.add-heatmap-calculation-options.name.y-bucket', 'Y Bucket'),
    editor: AxisEditor,
    category,
    defaultValue: {
      mode: HeatmapCalculationMode.Size,
  ...
  builder.addCustomEditor({
    ...
    name: t('transformers.add-heatmap-calculation-options.name.y-bucket-scale', 'Y Bucket scale'),
    category,
