...
const supplier = (
  ...
  builder.addSelect({
    path: `action`,
    name: t('transformers.supplier.name.action', 'Action'),
    description: '',
  ...
  if (options.action === SpatialAction.Calculate) {
    builder.addSelect({
      path: `calculate.calc`,
      name: t('transformers.supplier.name.function', 'Function'),
      description: '',
    ...
    builder.addSelect({
      path: `modify.op`,
      name: t('transformers.supplier.name.operation', 'Operation'),
      description: '',
